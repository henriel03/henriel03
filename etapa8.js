...
function draw() {
  tempo++
  background(0);
   if ( dist(a,b,460,yq) < raio+raioJ ) { //colisaão com o adversario e troca de cor
     if ( colisao == false) { 
       pontos+=10      
       colisao = true; 
     }
 }
  if ( dist(ao,bo,x,y) < raio+raioJ ) { //colisaão com o ajogador e perda de vida
  ...
  if((a>=50 && a<80 && b>60 && b<190) || (a>=50&& a<80 && b>330 && b<460)){
   a+=700
    if ( colisao == false) {  
  ...
  if((ao>=200 && ao<220 && bo>yb1 && bo<(70+yb1)) || (ao>=200 && ao<220 && bo>yb2 && bo<(70+yb2))){
   ao+=700
    if ( colisaoo == false) {  
  ...
  if((a>=200 && a<220 && b>yb1 && b<(70+yb1)) || (a>=200 && a<220 && b>yb2 && b<(70+yb2))){
   a+=700
    if ( colisao == false) {  
...
if(y<25){
  ...
  rect(60,60,15,130); // barreira de proteção do jogador
